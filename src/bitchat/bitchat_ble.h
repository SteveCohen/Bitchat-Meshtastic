...
public:
    ...
    void loop() override;
    bool send_text(const char *text, const char *geohash = nullptr) override;
    bool send_text_as(const char *text, const BitchatKeypair *identity,
                      const char *geohash = nullptr) override;
